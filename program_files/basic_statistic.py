...
with open("scaffold_basic_infomation.txt","w") as results_file:
    ...
    print("{0:16}{1:16}{2:16}{3:16}{4:16}{5:16}{6:16}".format("scaffold.fa",str(total_length),str(effective_lenth),str(N_length),str(scaffold_N50_length),str(scaffold_N50_length),str(gc_rate)))
